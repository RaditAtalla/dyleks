        ...
        {cards.map((card) => {
          ...
          return (
            <button
              ...
              className={`h-28 rounded-2xl border flex flex-col items-center justify-center transition-all duration-300 relative overflow-hidden select-none active:scale-95 ${
                card.isMatched
            ...
            >
              ...
              {isOpen && (
                <div className="flex flex-col items-center justify-center p-1 w-full h-full animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <span className={`font-black text-center break-words leading-tight px-1 w-full ${
                    card.value.length > 5 
                      ? 'text-[11px]' 
                      : card.value.length > 3 
                      ? 'text-xs' 
